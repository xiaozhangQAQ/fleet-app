...
<script>
	...
	import {carManageCostStatistics} from '@/api/api.js'
	import {
	    mapState 
	} from 'vuex'; 
	export default {
		...
		methods:{
			...
			inidata(){
				carManageCostStatistics({accountId:this.userInfo.accountId,date:this.usedate,fkOrgId:this.departs.id || ''}).then(res=>{
					this.datas = res.data;
				})
			}
		}
